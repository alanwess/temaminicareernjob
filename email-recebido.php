<?php get_header(); //Template Name: Email Recebido ?> 

    <main>
      <section>
        <div class="container">

          <h3>Muito Obrigado, recebemos seu contato ;)</h3>
          <p><i class="fa fa-check"></i> Sua solicitação foi recebida com sucesso, estaremos lhe respondendo assim que possível <i class="fa fa-envelope"></i></p>
