<?php
  ...
  function indeed_api_create_post($request) {
  ...
  function registrar_indeed_api_create_post() {
    register_rest_route('api', '/createjobindeed', array(
      array(
        'methods' => WP_REST_Server::CREATABLE,
        'callback' => 'indeed_api_create_post',
      ),
    ));
  }
  add_action('rest_api_init', 'registrar_indeed_api_create_post');
